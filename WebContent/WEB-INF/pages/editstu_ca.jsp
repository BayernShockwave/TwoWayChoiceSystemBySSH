...
<html>
  ...
  <meta charset="utf-8">
   ...
   <form action="update_ca" method="post" class="smart-green">
    ...
    <label>
        <span>学号:</span>
        <input id="sno" type="text" name="sno" class="error" value="${s.sno}" readonly />
    </label>
    
    <label>
        <span>密码:</span>
        <input id="spwd" type="text" name="spwd" class="error" value="${s.spwd}" readonly />
    </label>
    ...
    <label>
        <span>学院:</span>
        <input id="scol" type="text"  name="scol" value="${s.scol}" readonly />
    </label>
