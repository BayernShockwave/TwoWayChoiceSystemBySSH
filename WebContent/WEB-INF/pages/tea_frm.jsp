...
<div id="leftmenu">
<ul>
<a href="teacher/checkinfo?teaid=${teaid}">查看个人信息</a><br/>
<br/>
<a href="teacher/changepwd?teaid=${teaid}">修改个人密码</a><br/>
<br/>
<a href="teacher/checkalready?teaid=${teaid}">查看已选学生</a><br/>
<br/>
<a href="teacher/checkstu?teaid=${teaid}">查看备选学生</a><br/>
<br/>
